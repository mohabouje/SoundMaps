...
class AudioRecorder : public QObject {
  ...
  Q_PROPERTY(ulong frameLength READ frameLength WRITE setFrameLength NOTIFY
                 frameLengthChanged)
  Q_PROPERTY(double sampleRate READ sampleRate WRITE setSampleRate NOTIFY
                 sampleRateChanged)
  Q_PROPERTY(double latency READ latency)
  Q_PROPERTY(
      double streamTimestamp READ streamTimestamp NOTIFY streamTimestampChanged)
  Q_PROPERTY(QStringList supportedSampleRates READ supportedSampleRates NOTIFY
                 supportedSampleRatesChanged)
public:
