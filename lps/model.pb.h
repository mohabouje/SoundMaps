...
class Code : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Code) */ {
 ...
 private:
  ...
  friend void ::protobuf_model_2eproto::InitDefaultsCodeImpl();
};
// -------------------------------------------------------------------
...
class Beacon : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Beacon) */ {
 public:
  ...
  #if LANG_CXX11
  Beacon(Beacon&& from) noexcept
    : Beacon() {
    *this = ::std::move(from);
  }

  inline Beacon& operator=(Beacon&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(Beacon& a, Beacon& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  float z_;
  friend struct ::protobuf_model_2eproto::TableStruct;
  friend void ::protobuf_model_2eproto::InitDefaultsBeaconImpl();
};
// -------------------------------------------------------------------
...
class Environement : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Environement) */ {
 public:
  ...
  #if LANG_CXX11
  Environement(Environement&& from) noexcept
    : Environement() {
    *this = ::std::move(from);
  }

  inline Environement& operator=(Environement&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(Environement& a, Environement& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  float height_;
  friend struct ::protobuf_model_2eproto::TableStruct;
  friend void ::protobuf_model_2eproto::InitDefaultsEnvironementImpl();
};
// ===================================================================
